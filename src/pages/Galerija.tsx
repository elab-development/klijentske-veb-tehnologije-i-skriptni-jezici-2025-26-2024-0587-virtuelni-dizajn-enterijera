...
const stavkeGalerije = {
  dnevna: [
    ...
    { id: 3, naziv: "Elegantna dnevna soba", slika: "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
    ...
    { id: 6, naziv: "Prostrana dnevna soba", slika: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGxpdmluZyUyMHJvb218ZW58MHx8MHx8fDA%3D" },
  ...
  kuhinja: [
    ...
    { id: 22, naziv: "Funkcionalna kuhinja", slika: "https://images.unsplash.com/photo-1484154218962-a197022b5858?q=80&w=1174&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
    ...
    { id: 25, naziv: "Prostrana kuhinja", slika: "https://images.unsplash.com/photo-1602028915047-37269d1a73f7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fGtpdGNoZW58ZW58MHx8MHx8fDA%3D" },
  ...
  kupatilo: [
    ...
    { id: 40, naziv: "Relaksirajuće kupatilo", slika: "https://images.unsplash.com/photo-1688786219616-598ed96aa19d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHJlbGF4JTIwYmF0aHJvb218ZW58MHx8MHx8fDA%3D" },
  ],
  radniProstor: [
    { id: 41, naziv: "Elegantan radni prostor", slika: "https://images.unsplash.com/photo-1515965885361-f1e0095517ea?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGVsZWdhbnQlMjB3b3Jrc3BhY2V8ZW58MHx8MHx8fDA%3D" },
    ...
    { id: 43, naziv: "Moderan radni prostor", slika: "https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8aG9tZSUyMHdvcmslMjBkZXNrfGVufDB8fDB8fHww" },
    ...
    { id: 45, naziv: "Svetao radni prostor", slika: "https://images.unsplash.com/photo-1505330622279-bf7d7fc918f4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aG9tZSUyMHdvcmslMjBkZXNrfGVufDB8fDB8fHww" },
    { id: 46, naziv: "Prostran radni prostor", slika: "https://plus.unsplash.com/premium_photo-1720707755672-fa44f1711954?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGhvbWUlMjB3b3JrJTIwc3BhY2V8ZW58MHx8MHx8fDA%3D" },
    { id: 47, naziv: "Kreativan radni prostor", slika: "https://images.unsplash.com/photo-1622588907467-915ab508ae2a?q=80&w=1219&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
    ...
    { id: 50, naziv: "Luksuzni radni prostor", slika: "https://plus.unsplash.com/premium_photo-1679690708613-0d10282f9d19?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8ZWxlZ2FudCUyMHdvcmtzcGFjZXxlbnwwfHwwfHx8MA%3D%3D" },
  ],
  trpezarija: [
    ...
    { id: 53, naziv: "Moderna trpezarija", slika: "https://images.unsplash.com/photo-1730104231026-46e3cf7c3141?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZGlubmluZyUyMHJvb218ZW58MHx8MHx8fDA%3D" },
    ...
    { id: 56, naziv: "Topla trpezarija", slika: "https://images.unsplash.com/photo-1519643381401-22c77e60520e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8ZGlubmluZyUyMHJvb218ZW58MHx8MHx8fDA%3D" },
    ...
    { id: 59, naziv: "Udobna trpezarija", slika: "https://images.unsplash.com/photo-1616486701797-0f33f61038ec?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZGlubmluZyUyMHJvb218ZW58MHx8MHx8fDA%3D" },
